    ...
    try {
      ...
      drafts.forEach((draft) => {
        ...
        draftDropdownChange.addEventListener("click", async () => {
          ...
          let selectedCourse = globalCourses.find(
            (course) => course.name === courseToUpdate,
          );
          ...
          if (selectedCourse && globalUserRef) {
            ...
            let draftIndex = globalUserRef
              .data()
              .drafts.findIndex((_draft) => _draft.id === draft.id);
        ...
        deleteButton.addEventListener("click", () => {
          const confirmation = prompt(
            'Are you sure you want to delete this draft? Type "yes" to confirm.',
          );
          if (confirmation === "yes") {
